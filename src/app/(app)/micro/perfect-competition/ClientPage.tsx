...
const PerfectCompetitionGraph = dynamic(() => import("@/components/graphs/PerfectCompetitionGraph"), {
  ssr: false,
  loading: () => <GraphSkeleton />,
});
import PracticeQuiz from "@/components/ui/PracticeQuiz";
import {
  perfectCompetitionContent,
  perfectCompetitionQuestions,
} from "@/data/perfect-competition-content";
import Link from "next/link";
import PageTransition from "@/components/layout/PageTransition";
import ScrollReveal from "@/components/layout/ScrollReveal";
import ModuleNav from "@/components/ui/ModuleNav";
import FlashcardDeck from "@/components/ui/FlashcardDeck";
import { perfectCompetitionFlashcards } from "@/data/flashcards/micro-flashcards";

export default function PerfectCompetitionClientPage() {
  return (
    <PageTransition>
    <div className="max-w-7xl mx-auto px-6 py-10 lg:py-14">
      <div className="module-breadcrumb">
        ...
        <span className="current">
          {perfectCompetitionContent.title}
        </span>
      </div>
      ...
      <div className="module-header">
        ...
        <p >
          {perfectCompetitionContent.subtitle}
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-[1fr_480px] gap-10 items-start">
        <div className="order-2 lg:order-1">
          <div className="prose-econ">
            {perfectCompetitionContent.sections.map((section, i) => (
          ...
          <div className="mb-10">
            ...
            <PracticeQuiz questions={perfectCompetitionQuestions} moduleId="perfect-competition" />
          </div>
