...
const ExternalityGraph = dynamic(() => import("@/components/graphs/ExternalityGraph"), {
  ssr: false,
...
import {
  publicGoodsContent,
  publicGoodsQuestions,
} from "@/data/public-goods-content";
import Link from "next/link";
import PageTransition from "@/components/layout/PageTransition";
import ScrollReveal from "@/components/layout/ScrollReveal";
import ModuleNav from "@/components/ui/ModuleNav";
import FlashcardDeck from "@/components/ui/FlashcardDeck";
import { publicGoodsFlashcards } from "@/data/flashcards/micro-flashcards";

export default function PublicGoodsExternalitiesClientPage() {
  return (
    <PageTransition>
        ...
        <div className="grid lg:grid-cols-[1fr_480px] gap-10 items-start">
          ...
          <div className="order-2 lg:order-1">
            <div className="prose-econ">
              {publicGoodsContent.sections.map((section, i) => (
                <ScrollReveal key={i}>
                  <div className="mb-8">
            ...
            <div className="mb-10">
              ...
              <PracticeQuiz questions={publicGoodsQuestions} moduleId="public-goods-externalities" />
            </div>
          ...
          <div className="mb-10">
            ...
            <FlashcardDeck cards={publicGoodsFlashcards} moduleId="public-goods-externalities" />
          </div>

          <ModuleNav courseId="micro" currentModuleId="public-goods-externalities" />
        </div>
