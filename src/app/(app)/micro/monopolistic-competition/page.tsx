...
const MODULE_ID = "monopolistic-competition";
...
const breadcrumbJsonLd = {
  ...
  "@type": "BreadcrumbList",
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Home", item: "https://www.econlearn.org" },
    { "@type": "ListItem", position: 2, name: "AP Microeconomics", item: "https://www.econlearn.org/micro" },
    { "@type": "ListItem", position: 3, name: mod.title, item: `https://www.econlearn.org${mod.href}` },
  ],
};
