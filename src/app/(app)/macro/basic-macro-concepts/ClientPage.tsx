...
import {
  basicMacroContent,
  basicMacroQuestions,
} from "@/data/basic-macro-content";
import Link from "next/link";
import PageTransition from "@/components/layout/PageTransition";
import ScrollReveal from "@/components/layout/ScrollReveal";
import ModuleNav from "@/components/ui/ModuleNav";
import FlashcardDeck from "@/components/ui/FlashcardDeck";
import { basicMacroFlashcards } from "@/data/flashcards/macro-flashcards";

export default function BasicMacroClientPage() {
  return (
    <PageTransition>
      <div className="max-w-3xl mx-auto px-6 py-10 lg:py-14">
        ...
        <div className="module-header">
          ...
          <p >
            {basicMacroContent.subtitle}
          </p>
        </div>

        <div className="prose-econ">
          {basicMacroContent.sections.map((section, i) => (
            <ScrollReveal key={i}>
              <div className="mb-8">
        ...
        <div className="mb-10">
          ...
          <PracticeQuiz questions={basicMacroQuestions} moduleId="basic-macro-concepts" />
        </div>
          ...
          <div className="mb-10">
            ...
            <FlashcardDeck cards={basicMacroFlashcards} moduleId="basic-macro-concepts" />
          </div>
          ...
          <ModuleNav courseId="macro" currentModuleId="basic-macro-concepts" />
      </div>
    </PageTransition>
  );
}
