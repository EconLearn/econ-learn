...
const FiscalPolicyGraph = dynamic(() => import("@/components/graphs/FiscalPolicyGraph"), {
  ssr: false,
...
import {
  fiscalPolicyContent,
  fiscalPolicyQuestions,
} from "@/data/fiscal-policy-content";
import Link from "next/link";
import PageTransition from "@/components/layout/PageTransition";
import ScrollReveal from "@/components/layout/ScrollReveal";
import ModuleNav from "@/components/ui/ModuleNav";
import FlashcardDeck from "@/components/ui/FlashcardDeck";
import { fiscalPolicyFlashcards } from "@/data/flashcards/macro-flashcards";

export default function FiscalPolicyClientPage() {
  return (
    <PageTransition>
      ...
      <div className="grid lg:grid-cols-[1fr_480px] gap-10 items-start">
        <div className="order-2 lg:order-1">
          <div className="prose-econ">
            {fiscalPolicyContent.sections.map((section, i) => (
          ...
          <div className="mb-10">
            ...
            <PracticeQuiz questions={fiscalPolicyQuestions} moduleId="fiscal-policy" />
          </div>
