...
export const basicConceptsContent = {
  ...
  subtitle:
    "Scarcity, opportunity cost, the production possibilities curve, and the logic of trade",
  sections: [
    {
...
Scarcity is not poverty. Jeff Bezos faces scarcity. He gets the same 24 hours you do, and an hour spent in a board meeting is an hour he can't spend sailing. The United States faces scarcity. Every dollar Congress sends to the Pentagon is a dollar that doesn't go to Medicare.

Since resources are scarce, every choice forces a **tradeoff**. Pick one thing, lose access to something else. The core economic problem isn't that people are poor. It's that no pile of resources is big enough to satisfy every want at once. Economics is the study of how people, firms, and governments divide up what's limited among everything they'd like to do with it.`,
    },
    {
      heading: "Opportunity Cost",
      content: `You graduate high school and face a choice: attend a four-year university or start working full-time at $35,000 a year. If you pick college, the sticker price (tuition, books, room and board) is only part of the cost. You also lose four years of paychecks. That lost income is your **opportunity cost**: the value of the next-best alternative you gave up.

A frequent mistake: suppose you turn down both a $35,000 job and a $20,000 job to attend school. Your opportunity cost is $35,000, the single best alternative, not the sum of every option you rejected. Opportunity cost never stacks. It's always the one road-not-taken that hurts the most.
...
The logic works at every scale. When Congress allocates $2 billion to a new aircraft carrier, the **opportunity cost** is the bridge repairs or school funding that money could have covered. When a startup spends its seed funding on engineers, the opportunity cost is the marketing campaign it can no longer afford. Every resource pointed in one direction is a resource pulled away from another.`,
    },
    {
      ...
      content: `Take a country that makes only two things: guns and butter. Throw every factory, every worker, every acre at gun production and you hit a ceiling. Maximum guns, zero butter. Reverse it and you get maximum butter, zero guns. Between those extremes sits a whole menu of possible mixes. The **production possibilities curve** (PPC) draws that menu as a line on a graph.

Your position relative to the curve tells you something specific. Points **on the curve** mean the economy is using all its resources: every worker employed, every machine running. You can't get more guns without giving up some butter. Points **inside the curve** mean something has gone wrong. Factories sit idle, workers are unemployed, capacity is wasted. The country could produce more of both goods just by putting those resources to work. Points **outside the curve** are out of reach given current resources and technology.

The PPC bows outward instead of forming a straight line because of **increasing opportunity costs**. When you shift workers from butter churns to weapons factories, the first batch you move are people who were mediocre at churning butter but decent with machinery. You lose little butter and gain a lot of guns. The last batch are your star butter-makers who know nothing about weapons manufacturing. Each additional gun now costs a huge pile of forgone butter. Resources aren't interchangeable, so the tradeoff gets steeper as you push toward either extreme.`,
    },
    {
      heading: "Opportunity Cost on the PPC",
      content: `Reading opportunity cost off a PPC is straightforward. Look at the **slope**. At any point on the curve, the slope tells you how many units of the vertical-axis good you sacrifice to get one more unit of the horizontal-axis good.
...
An **outward shift** means the economy can now make more of both goods. That is economic growth. Causes include:
...
The shift doesn't have to be even across both goods. A breakthrough in agricultural biotech might double crop yields but do nothing for steel production. The PPC **pivots**: the food-axis endpoint pushes outward while the steel-axis endpoint stays put.

A point outside the curve you couldn't reach last year? After an outward shift, it's now on or inside the new frontier. Economic growth is the frontier moving outward over time. What was impossible yesterday becomes achievable today.`,
    },
    {
...
Country A has the absolute advantage in both goods (it can produce more of each). That doesn't matter. Comparative advantage is about who sacrifices less, not who produces more.
...
export const basicConceptsQuestions: PracticeQuestion[] = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "Resources aren't one-size-fits-all. Farmland makes lousy factory floor, and machinists make lousy farmers. As you push production of one good further, you're pulling in resources that are worse and worse at making it, so each extra unit costs more of the other good — increasing opportunity costs. That's what creates the bowed-out shape. Option A describes a straight-line PPC (constant costs). Option B would produce a curve that bows inward, which isn't the standard shape. Option D (economies of scale) is a different concept entirely and wouldn't produce this shape.",
  },
  {
    id: "bc-5",
    question:
    ...
    options: [
      ...
      "Neither — they have equal opportunity costs",
    ],
    correctIndex: 1,
    explanation:
