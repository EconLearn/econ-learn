...
export const oligopolyContent = {
  title: "Oligopoly",
  subtitle:
    "How a handful of dominant firms play a strategic game where every move triggers a counter-move",
  sections: [
    {
...
Firms in an oligopoly can produce *identical* products (steel, aluminum, a **homogeneous oligopoly**) or *differentiated* ones (Samsung vs. Apple phones). Either way, strategic interdependence remains.`,
    },
    {
      ...
      content: `You are a pricing executive at American Airlines. You could cut fares on the Chicago-to-Miami route by 20% and steal passengers from United. Sounds good until United retaliates with a 25% cut, Southwest jumps in, and everyone's margins are destroyed. Both airlines would have been better off keeping prices high.

**Game theory** is the study of strategic decision-making when your outcome depends on what the other player does. In oligopoly, firms are not just reacting to supply and demand. They are anticipating each other's moves.
...
The tension between *individual rationality* and *collective interest* sits at the core of oligopoly. Firms want to cooperate and keep prices high together, but the temptation to cheat is overwhelming.`,
    },
    {
      ...
      content: `Where do the airlines actually end up? The answer comes from mathematician John Nash (yes, the *A Beautiful Mind* guy).

A **Nash equilibrium** occurs when no player can improve their outcome by *unilaterally* changing their strategy, given what the other player is doing. In the airline example, both cutting fares is the Nash equilibrium. Once both are cutting, neither gains by switching to high fares alone. They would just lose market share.

The painful part: the Nash equilibrium is *not* the best collective outcome. Both firms earning $4M is worse than both earning $10M. But it is *stable*. Neither firm has an incentive to deviate on its own. Oligopolies therefore tend to produce outcomes better for consumers than monopoly but worse than perfect competition.
...
Every cartel faces the same problem: *cheating is irresistible*. If American and United agree to keep fares high, each earns $10M. But American knows it could secretly offer discount fares, grab extra passengers, and earn $12M while United naively holds the line. Every cartel member faces this temptation. Cartels are therefore inherently unstable.

OPEC demonstrates this constantly. Member countries regularly exceed their production quotas, pumping extra oil for additional revenue and hoping others will not notice. When enough members cheat, discipline breaks down and prices fall.
...
- The market is *stable* (demand is not fluctuating wildly)
- Firms interact *repeatedly* (the threat of future retaliation keeps everyone honest)

Even without explicit agreements, firms sometimes engage in **tacit collusion**, coordinating behavior without direct communication. One airline raises fares and others follow within hours. Legal, since proving a secret agreement is nearly impossible, but the economic effects are similar.`,
    },
    {
      heading: "The Kinked Demand Curve",
      content: `Oligopoly prices often stay *remarkably stable* even when costs change. Gas stations on the same intersection hold the same price for weeks. Airlines keep fares locked on popular routes. Why?

The **kinked demand curve** model offers one explanation, starting with a simple assumption about how rivals react:

*If you raise your price, competitors will not follow.* They happily watch you lose customers to them. Demand above the current price is therefore very elastic. A small price increase causes a big drop in your sales.

*If you cut your price, competitors will match you immediately.* They cannot afford to lose market share. Demand below the current price is relatively inelastic, since a price cut barely increases your sales when rivals neutralize it.
...
Oligopoly prices are sticky because firms resist raising prices (they lose customers) and resist cutting them (rivals match, leaving everyone worse off). Prices cluster together and stay put, changing only when costs or demand shift dramatically.

The model has critics. It explains *why* prices are sticky but not *how* the current price got established in the first place. Still, it captures an important reality of oligopoly behavior and shows up regularly on the AP exam.`,
    },
    {
...
**Cooperative outcome:** If both firms could credibly commit to Low Ads, they would each earn $7M, better for *both*. But the agreement is unstable. If Apple trusts Samsung to keep ads low, Samsung can defect to High Ads and jump from $7M to $9M. The incentive to cheat destroys cooperation.
...
export const oligopolyQuestions: PracticeQuestion[] = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "Repeated interactions make collusion more sustainable because firms can punish cheaters in future rounds — the threat of retaliation keeps everyone in line. (A) is wrong because more firms means it's harder to coordinate and monitor behavior. (B) makes collusion harder because differentiated products make it difficult to agree on a common price or detect secret discounts. (D) is wrong because unstable demand creates uncertainty about whether a rival's price cut is cheating or just responding to market conditions.",
  },
  {
    id: "olig-7",
    question:
