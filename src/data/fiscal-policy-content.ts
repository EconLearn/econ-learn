...
export const fiscalPolicyContent = {
  title: "Fiscal Policy",
  subtitle: "How government spending and taxation shift aggregate demand and stabilize the economy",
  sections: [
    {
      heading: "Expansionary and Contractionary Fiscal Policy",
      content: `When COVID shut down the economy in 2020, Congress passed trillions in spending and relief checks rather than waiting for markets to self-correct. That is fiscal policy: the federal government using its spending and taxing power to shift aggregate demand. Congress and the president control these levers, which is what distinguishes fiscal policy from monetary policy (the Fed's domain).
...
**Contractionary fiscal policy** works in reverse. An overheating economy with an inflationary gap calls for spending cuts or tax increases to shift AD left. The political reality, though: nobody wins elections by raising taxes or slashing popular programs. Contractionary fiscal policy is rare. The economics are clean, but the politics are brutal.`,
    },
    {
      heading: "The Spending Multiplier",
      content: `The government hires a contractor for $1 million to repair a bridge. That contractor pays workers, who take their paychecks to grocery stores, landlords, and car dealerships. Those businesses pay their employees, who spend again. One dollar of government spending cycles through the economy multiple times. That is the **multiplier effect**.

The size depends on the **marginal propensity to consume (MPC)**, the fraction of each new dollar that people spend rather than save.
...
With an MPC of 0.8 (people spend 80 cents of every new dollar), the multiplier is 1 / 0.2 = 5. A $10 billion infrastructure bill shifts AD right by $50 billion as the money cascades through successive spending rounds. Raise the MPC to 0.9 and the multiplier jumps to 10. The more people spend out of each dollar, the longer the chain runs.`,
    },
    {
      ...
      content: `A question the AP exam returns to constantly: why does a $10 billion tax cut produce a smaller AD shift than $10 billion in government spending? The answer is leakage at the start. If the MPC is 0.8, households save 20% of the tax cut before spending a cent.
...
The gap comes from the first round. Government spending injects all $10 billion immediately. A tax cut puts $10 billion in household pockets, but they save $2 billion before any spending happens. Only $8 billion enters the multiplier chain. The spending multiplier always exceeds the tax multiplier (in absolute value) by exactly 1, regardless of the MPC.`,
    },
    {
...
Higher rates make it more expensive for companies to finance factories, for developers to build housing, and for consumers to borrow for big purchases. Private investment drops, partially offsetting the government's spending boost. The **crowding-out effect** means the actual AD shift is smaller than the textbook multiplier predicts.

How much crowding out occurs depends on context. During the depths of 2008, private investment demand had already collapsed and rates sat near zero. There was not much private borrowing to displace. But in a fully employed economy where firms actively compete for loans, government borrowing can significantly raise rates and squeeze out private investment. Full crowding out, where every government dollar displaces a private dollar, is the theoretical extreme. Partial crowding out is the norm.`,
    },
    {
      heading: "Automatic Stabilizers",
      content: `Congress is slow. Passing a stimulus bill takes months of debate and political negotiation. By the time relief arrives, the recession may be over or far worse. **Automatic stabilizers** bypass that lag entirely because they activate without new legislation.

On the revenue side, the U.S. has a **progressive income tax**. If your income drops from a layoff or reduced hours, you fall into a lower bracket and owe less tax automatically. Disposable income does not drop as far as gross income did. During expansion, rising incomes push people into higher brackets, and the extra taxes act as a natural brake on spending.
...
Automatic stabilizers dampen the business cycle, but they cannot end a deep recession on their own. They absorb shocks. They do not generate recovery.`,
    },
    {
      heading: "Budget Deficits and the National Debt",
      content: `In 2020, the U.S. federal government spent roughly $6.5 trillion and collected about $3.4 trillion. The $3.1 trillion gap is a **budget deficit**. The Treasury covers the shortfall by selling bonds to pension funds, foreign governments, individual investors, and banks.

Stack every deficit (minus the occasional surplus) the government has run and you get the **national debt**. Deficit is a flow, how much red ink in a single year. Debt is a stock, the total pile of IOUs outstanding.

In theory, the budget should roughly balance over a full business cycle: deficits during recessions offset by surpluses during booms. In practice, surpluses are rare. Cutting spending and raising taxes cost politicians their jobs, so deficits persist even during expansions.

Whether high debt matters is one of the sharpest divides in economics. The concern: interest payments consume a growing share of the budget, future taxes must rise to service the debt, and creditors may eventually demand higher rates. The counter: a government borrowing in its own currency can always make payments, and the meaningful metric is **debt-to-GDP ratio**, not raw dollars. Japan's debt exceeds 250% of GDP, and it still borrows at low rates.`,
    },
    {
...
The trade-off is real in the short run. But there is a critical limit. If the government keeps pumping stimulus after the economy has returned to full employment, the short-run Phillips Curve itself shifts upward as workers and firms adjust their inflation expectations. Eventually, unemployment returns to the **natural rate**, but at a permanently higher inflation level. That is the long-run Phillips Curve in action — a vertical line at the natural rate, just like LRAS is vertical at potential output.
...
For the AP exam, connect the graphs. An expansionary fiscal policy question should trigger three mental pictures: AD/AS (AD shifts right, GDP up, price level up), the money market (higher income raises money demand, pushing up interest rates), and the Phillips Curve (unemployment down, inflation up). Mastering these connections is what separates a 3 from a 5.`,
    },
    {
      ...
      content: `Congress debates two proposals to fight a recession. MPC = 0.75.
...
Both policies raise real GDP and the price level as the economy moves up along the SRAS curve. The policy question is straightforward: how much stimulus per dollar does Congress want?`,
    },
  ],
};
