...
The result: **less output** and a **higher price** than what a competitive market would produce. Competition pushes production out to where P = MC. The monopolist stops well short of that, leaving willing buyers unserved.`,
    },
    {
      ...
      content: `A patient would pay $200 for a drug that costs $30 to produce. Under competition, that transaction happens and both sides benefit. Under monopoly, the firm prices the drug at $250 and the patient walks away with nothing. The $170 of potential surplus that would have existed — gone. Neither party captures it.
...
DWL is *not* the monopolist's profit — students confuse these two constantly. Profit is a transfer of surplus from consumers to the producer, but that surplus still exists somewhere in the economy. Deadweight loss is surplus that vanishes entirely.

The U.S. Department of Justice pursues **antitrust regulation** because of this. The wider the gap between Qm and Qc, the larger the DWL triangle, and the more society loses. The 1998 antitrust case against Microsoft, the 2020 suit against Google — the underlying economic argument in every major antitrust action traces back to deadweight loss and consumer harm.`,
    },
    {
...
The monopolist produces 24 fewer units (36 vs. 60) and charges $24 more ($64 vs. $40). Every unit between Q = 36 and Q = 60 would have generated surplus for somebody — buyers valued those units above production cost. That lost triangle is the deadweight loss.`,
    },
  ],
};
...
export const monopolyQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: "The monopolist restricts output to where MR = MC, which means fewer units than competition's P = MC outcome. Fewer units on the market means a higher price along the demand curve. (A) contradicts basic demand logic — you can't sell more at a higher price without a demand shift. (C) describes what competition delivers, not monopoly. (D) is impossible; the monopolist raises price precisely *by* restricting the quantity.",
  },
  {
    id: "mon-4",
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: "Profit per unit is (P − ATC), and total economic profit is that margin times quantity. On the graph, it shows up as the shaded rectangle from ATC up to P, with width Qm. (A) requires P = ATC exactly — the break-even case, which isn't what the question describes. (C) has the inequality flipped; P > ATC means the firm is profitable, not losing money. (D) confuses revenue maximization (where MR = 0) with profit maximization (where MR = MC). A firm chasing maximum revenue ignores costs and produces too much.",
  },
  {
    id: "mon-9",
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: "The monopolist restricts output below the competitive level. Units between Qm and Qc would have generated surplus — buyers valued them above MC — but they're never produced. That lost surplus is deadweight loss, and nobody receives it. (A) is wrong because monopoly *reduces* total surplus; restricting output destroys value regardless of the firm's efficiency. (C) describes perfect (first-degree) price discrimination, not single-price monopoly — a single-price monopolist leaves consumer surplus intact for buyers who value the good above the monopoly price. (D) has it backwards; the monopolist's producer surplus actually *increases* relative to competition because the higher price on units sold more than compensates for reduced volume.",
  },
];
