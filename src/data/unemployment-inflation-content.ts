  ...
  sections: [
    {
      ...
      content: `Economists split unemployment into three buckets, and knowing which bucket someone falls into matters a lot for policy, because you can't fix structural unemployment with a stimulus check.
...
**Cyclical unemployment** is the one that tracks recessions directly. Aggregate demand tanks, businesses slash payrolls, layoffs cascade through sector after sector. The 2008-2009 financial crisis and the early weeks of COVID in 2020 are classic examples. Once GDP climbs back to potential, cyclical unemployment goes away.
...
**Underemployment** is the other blind spot. A software engineer who can't find tech work and is pulling espresso shots part-time at Starbucks shows up as "employed" in the official data. The BLS does publish a U-6 measure that captures discouraged workers plus people stuck in involuntary part-time jobs, but nobody puts U-6 in newspaper headlines. On the AP exam, if a question describes someone working part-time who wants full-time work, that's underemployment and the U-3 rate misses it completely.`,
    },
    {
      ...
      content: `Gas hit $5.02 a gallon in June 2022, which was AAA's highest recorded national average ever. Grocery bills were up something like 10% year-over-year. The government boils all of that price movement down to one number through the **Consumer Price Index (CPI)**, which tracks the cost of a fixed **market basket** of stuff a typical urban household buys.
...
What shifts the SRPC? Expected inflation, mainly. When people start expecting higher inflation (because they've been living through it, or because the Fed signals loose policy), the whole curve shifts up so that at every unemployment rate, actual inflation runs higher. When expectations cool back down, the curve drops. After Volcker, anchoring inflation expectations became basically the central obsession of central banking worldwide.`,
    },
    {
      ...
      content: `On October 17, 1973, the Organization of Arab Petroleum Exporting Countries slapped an oil embargo on nations that backed Israel in the Yom Kippur War. Oil prices quadrupled within months. Inflation surged. Unemployment surged. Both at the same time.
...
export const unemploymentInflationQuestions: PracticeQuestion[] = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: "((210 - 200) / 200) x 100 = 5%. You divide by the OLD CPI, not the new one. The most common mistake is picking A, where students see the 10-point jump and write 10%, confusing a raw point change with a percentage. C (4.76%) comes from dividing by 210 instead of 200. D has no basis in the formula at all.",
  },
  {
    id: "ui-4",
