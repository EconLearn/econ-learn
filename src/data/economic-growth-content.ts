...
**Promote trade openness.** Access to larger markets, cheaper inputs, and foreign technologies accelerates growth. Japan after 1868, South Korea after 1961, Taiwan, Singapore, and China after 1978 all relied heavily on export-led strategies. Trade lets countries specialize where they are most productive and import the rest, which is Ricardo's comparative advantage logic applied at national scale.
...
export const economicGrowthQuestions: PracticeQuestion[] = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "TFP is the residual, meaning output growth left over after accounting for labor and capital inputs. It captures technological progress, better management, and efficiency gains. Solow called it the \"measure of our ignorance\" because it encompasses everything beyond raw input accumulation. Options A and B describe input-driven growth, which is precisely what TFP excludes. Option D confuses population growth with productivity.",
  },
  {
    id: "eg-4",
    question:
    ...
    correctIndex: 2,
    explanation:
      "South Korea's transformation was driven by massive investments in human capital, physical capital, strong institutional frameworks, and an export-led strategy that Park Chung-hee's government initiated in the 1960s. Option A is actually backwards because South Korea has relatively few natural resources. Option B is incorrect because population size alone does not determine per-capita trends; growth rates do. The resource curse literature suggests natural wealth can even hinder institutional development.",
  },
  {
    id: "eg-5",
    question:
    ...
    correctIndex: 2,
    explanation:
      "Human capital is the knowledge, skills, training, and health embodied in workers. An engineer's training directly increases productive output. Options A and B are physical capital. Option D is a financial asset and is neither physical nor human capital in the growth accounting sense.",
  },
  {
    id: "eg-6",
    question:
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "Sustained growth means the economy's productive capacity permanently expands, so more labor, capital, or technology shifts LRAS rightward. Option A raises output only temporarily in the short run and primarily increases the price level long-term. Option B reduces output. Option D is geometrically impossible because you cannot move along a vertical line.",
  },
  {
    id: "eg-8",
    question:
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "Labor and capital both face diminishing returns, so each additional unit contributes less when other inputs are held constant. Technology breaks that constraint by enabling existing inputs to produce more. A more efficient engine, a better algorithm, a new pharmaceutical does not simply add another unit of input; it raises the productivity of every existing unit. Solow showed in 1956 that TFP growth is the only sustainable engine for capital-saturated economies. Option A is irrelevant to why technology drives growth. Option C is wrong; advanced economies do accumulate more capital, but each unit yields less. Option D overstates the case because technology complements capital and labor rather than replacing them.",
  },
];
