...
export const monetaryPolicyContent = {
  ...
  subtitle: "The Federal Reserve's toolkit for influencing interest rates, investment, and aggregate demand through the money supply",
  sections: [
    {
      heading: "The Money Market Model",
      content: `Think about it this way: why would you keep cash sitting in your wallet when a savings account pays interest? The opportunity cost of holding money is the interest you give up, and that tradeoff is exactly what the money market model captures.

The graph puts the **nominal interest rate** on the vertical axis and the quantity of money on the horizontal. The **money supply (MS)** curve is near-vertical because the Federal Reserve decides how much money exists, and market interest rates don't alter that decision. The **money demand (MD)** curve slopes downward: when rates are high, holding cash is expensive (you're sacrificing bond returns), so people hold less of it. When rates are low, cash is cheap to hold.

Where MS crosses MD, you get the equilibrium interest rate. If the market rate sits above equilibrium, people are holding more money than they want. They buy bonds, bond prices rise, and rates fall back down. Below equilibrium, the opposite pressure pushes rates up.`,
    },
    {
      heading: "The Federal Reserve's Tools",
      content: `The Fed shifts the MS curve using three tools. Each one targets bank reserves from a different angle.

**Open market operations (OMOs)** are the big one. The Fed buys government bonds from banks, credits their reserve accounts with fresh money, and banks lend out the excess. Through the money multiplier, a single bond purchase ripples into a much larger expansion of the money supply. Selling bonds reverses the process, draining reserves and contracting the supply. During 2020, the Fed purchased over $80 billion in Treasuries per month to flood the banking system with liquidity.
...
One overnight rate between banks might sound inconsequential, but it sets the floor for the entire credit market. When the federal funds rate moves, banks adjust prime lending rates, which reprices mortgages, auto loans, corporate debt, and credit cards. A decision in a Washington boardroom reaches a family financing a home in Ohio within weeks.`,
    },
    {
      ...
      content: `Early 2020: GDP is collapsing, unemployment is spiking, and the economy has a textbook **recessionary gap** with real GDP far below potential. The Fed's response was expansionary policy, or "easy money."
...
The Fed under Jerome Powell raised the federal funds rate from near-zero to over 5% between March 2022 and July 2023. That was the fastest tightening cycle in decades, and it worked precisely through this mechanism.`,
    },
    {
      heading: "The Transmission Mechanism",
      content: `What actually connects a Fed bond purchase to a family buying a house or a factory expanding production? The **transmission mechanism** traces every link in that chain, and AP free-response questions will test whether you can walk through it.

The full chain: **Fed action -> money supply -> interest rate -> investment -> aggregate demand -> real GDP and price level.**

Weak links can break the chain. If money demand is nearly flat (highly elastic), even a big shift in money supply barely moves the interest rate. If businesses are deeply pessimistic, as they were in 2009, rock-bottom rates still won't spur borrowing. This asymmetry explains why monetary policy tends to be more effective at cooling an overheating economy than at reviving a depressed one. Paul Volcker proved the first half in 1980-82 by crushing inflation with punishing rates. The Fed's struggle to spark recovery after 2008 showed the second.
...
Here's the critical insight: the **long-run Phillips Curve is vertical** at the natural rate of unemployment, just as LRAS is vertical at full-employment output. Monetary policy can shift the economy along the short-run curve but can't permanently push unemployment below the natural rate. Attempting to do so only results in higher expected inflation, which shifts the SRPC itself upward.

For the AP exam, every monetary policy free-response question benefits from connecting to the Phillips Curve. The Fed buys bonds, interest rates fall, AD shifts right, and on the Phillips Curve the economy moves to lower unemployment and higher inflation. Draw it.`,
    },
    {
      heading: "Worked Example",
      content: `The Fed buys $100 million in government bonds on the open market. Let's trace what happens.
...
**Money market graph.** MS shifts right by $1 billion. Money demand is unchanged, so the equilibrium interest rate falls. How far it falls depends on the slope of MD: a steeper curve means a bigger rate swing, a flatter one means a smaller swing.
...
export const monetaryPolicyQuestions: PracticeQuestion[] = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: "This is the \"pushing on a string\" problem. After 2008, the Fed slashed rates to near-zero, but banks sat on excess reserves and businesses saw no reason to borrow because the economy was too weak for investment to look profitable. The transmission mechanism breaks at the investment link. Option A is wrong because the Fed can always buy bonds and expand the money supply; the bottleneck is private-sector willingness to borrow and spend. Option C is wrong because low rates do not automatically cause inflation, especially in a depressed economy. Option D is wrong because there is no mechanism that makes money demand vertical during recessions.",
  },
  {
    id: "mp-9",
